 ...
 //       fetchCapacity();
    ...
    return (
        <div className="bicicleteros-page">
            ...
            <button className="bicicleteros-addbtn" onClick={() => handleCreateBikeRack()}>Añadir</button>
            </div>
                ...
                {Array.isArray(bikeRacks) && bikeRacks.length > 0 ? (
                    bikeRacks.map((bikeRack) => (
                        <tr key={bikeRack.id_bicicletero}>
                            ...
                            <td>{bikeRack.estado}</td>
                            <td>
                                <button className="capacity" onClick={() => handleGetCapacityBikeRack(bikeRack.id_bicicletero)}>Consultar espacios</button>
                                
                            </td>
                            <td>
                                <button className="delete" onClick={() => handleDeleteBikeRack(bikeRack.id_bicicletero)}>Eliminar</button>
